...
const Header = ({ title, onAdd, showAdd }) => {
  return (
    <header className="header">
      ...
      <Button
        color={showAdd ? "red" : "green"} //if showAdd is true then color is red else color is green
        text={showAdd ? "Close" : "Add"} //if showAdd is true then text is Close else text is Add
        onClick={onAdd}
      />
    </header>
  );
